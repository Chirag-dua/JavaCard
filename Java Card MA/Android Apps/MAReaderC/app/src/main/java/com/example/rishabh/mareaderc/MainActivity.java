...
public class MainActivity extends ReaderActivity
{
    ...
    public void onHceStarted(IsoDep isoDep)
    {
        ...
        boolean success = mutualAuthentication(isoDep, str);
        if(!success)
        ...
        else
        {
            ...
            str.append("Total elapsed time: " + elapsedTime / 1000000 + "\n");
            final StringBuffer pstr = str;
            runOnUiThread(new Runnable() {
                @Override
                public void run()
                {
                    TextView textView = (TextView) findViewById(R.id.textbox);
                    textView.setText(pstr.toString());
                }
            });
    ...
    boolean mutualAuthenticationAsymm(IsoDep isoDep, StringBuffer str)
    {
        ...
        try
        {
            ...
            Log.i(tag, "Time for retrieving keyr||IDr from the SE: " + elapsedTime/1000000);
            ...
            elapsedTime = System.nanoTime() - startTime;
            Log.d(tag, "Time for sending signature to the HCE: " + elapsedTime/1000000);
            str.append("Time for sending signature to the HCE: " + elapsedTime/1000000 + "\n");
            ...
            elapsedTime = System.nanoTime() - startTime;
            Log.d(tag, "Time for sending Keyr || IDr to the HCE: " + elapsedTime/1000000);
            str.append("Time for sending Keyr || IDr to the HCE: " + elapsedTime/1000000 + "\n");
            startTime = System.nanoTime();
            ...
            elapsedTime = System.nanoTime() - startTime;
            Log.d(tag, "Time for receiving Certc || E(KPbr, nc||IDc) from HCE: " + elapsedTime/1000000);
            str.append("Time for receiving Certc || E(KPbr, nc||IDc) from HCE: " +
                    elapsedTime/1000000 + "\n");
            ...
            elapsedTime = System.nanoTime() - startTime;
            Log.d(tag, "Time for sending Certc to SE: " + elapsedTime/1000000);
            ...
            elapsedTime = System.nanoTime() - startTime;
            Log.d(tag, "Time for sending E(KPbr, nc||IDc) to SE: " + elapsedTime/1000000);
            str.append("Time for sending E(KPbr, nc||IDc) to SE: " + elapsedTime/1000000 + "\n");
            startTime = System.nanoTime();
            byte[] nextMessageToBeSent = readEncStuff();
            elapsedTime = System.nanoTime() - startTime;
            Log.d(tag, "Time for reading E(KPbc, nc||IDc||nr||IDr) from the SE: " + elapsedTime/1000000);
            ...
            elapsedTime = System.nanoTime() - startTime;
            Log.d(tag, "Time for sending E(KPbc, nc||IDc||nr||IDr) to the HCE: " + elapsedTime/1000000);
            str.append("Time for sending E(KPbc, nc||IDc||nr||IDr) to the HCE: " + elapsedTime/1000000 + "\n");
            startTime = System.nanoTime();
            setCommandForRead(commandAuth, this.ASK_CONF);
            res = transactNfc(isoDep, commandAuth);
            elapsedTime = System.nanoTime() - startTime;
            Log.d(tag, "Time for receiving E(KPbr, Ks||nr||IDr) from the HCE: " + elapsedTime/1000000);
            str.append("Time for receiving E(KPbr, Ks||nr||IDr) from the HCE: " + elapsedTime/1000000 + "\n");
            ...
            elapsedTime = System.nanoTime() - startTime;
            Log.d(tag, "Time for sending  E(KPbr, Ks||nr||IDr) to the SE: " + elapsedTime/1000000);
